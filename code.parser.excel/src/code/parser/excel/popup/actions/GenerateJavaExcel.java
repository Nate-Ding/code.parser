package code.parser.excel.popup.actions;
...
import code.parser.excel.convertor.JavaCode2ExcelConvertor;
...
public class GenerateJavaExcel implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			new JavaCode2ExcelConvertor().convert(array.toJSONString(), outFile);
